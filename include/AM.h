...
#define MAXSCANS 20
extern FileMeta OpenIndexes[MAXOPENFILES];
extern SearchData OpenSearches[MAXSCANS];
...
#define AME_OK 0
#define AME_EOF -1
#define AME_BF_CALL_ERROR -2
#define AME_CREATE_INPUT_ERROR -3
...
#define AME_INVALID_OP -9
#define AME_NO_SPACE_FOR_SEARCH -10
#define AME_CANNOT_DESTROY_SEARCH_OPEN -11
#define AME_KEY_NOT_EXIST -12
#define AME_END_OF_FILE -13
#define AME_CANNOT_INSERT_SEARCH_OPEN -14
#define AME_CANNOT_CLOSE_SEARCH_OPEN -15
#define CANNOT_DESTROY_SEARCH_OPEN -16
